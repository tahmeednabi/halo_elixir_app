...
#
#     PHX_SERVER=true bin/halo_elixir_app start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :halo_elixir_app, HaloElixirAppWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :halo_elixir_app, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :halo_elixir_app, HaloElixirApp.Mailer,
